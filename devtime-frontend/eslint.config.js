      ...
      '@angular-eslint/template/i18n': [
        'error',
        {
          ...
          ignoreAttributes: [
            ...
            'appendTo',
            'aria-current',
            // Referências a `id` de outro elemento e valores de estado: não são texto ao usuário.
            'aria-describedby',
            'aria-hidden',
            'aria-invalid',
            'aria-labelledby',
            ...
            'role',
            'rows',
            // `scope` associa cabeçalho e célula de tabela (A11Y-12); o valor é `col` ou `row`.
            'scope',
            'severity',
            'src',
            'styleClass',
